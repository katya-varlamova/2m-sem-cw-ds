...
public:
    ...
    std::string createToken(const std::string &login, const std::string &role, const std::string &scope_string)
    {
        ...
        return jwt::create()
                            ...
                            .set_payload_claim("scope_string", jwt::claim(scope_string))
